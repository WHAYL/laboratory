...
http {
    ...
    server {
        ...
        location / {
            root    E:/nginx+mysql+php/www/demo/tp/public;
 ...
 server {
        ...
        location / {
            root    E:/nginx+mysql+php/www/demo/laboratory/public;
            index   index.html index.htm index.php;
...
[mysqld]
port=3306
basedir=E:\\nginx+mysql+php\\mysql
datadir=E:\\nginx+mysql+php\\mysql\\data 
max_connections=200
